            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ url('users/' .$user->id) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            <label for="profile_text" class="col-md-4 col-form-label text-md-right">{{ __('Background') }}</label>

                            <div class="col-md-6">
                                <textarea name="profile_text" id="profile_text" class="form-control @error('profile_text') is-invalid @enderror" cols="30" rows="4" required autocomplete="profile_text">{{ $user->profile_text }}</textarea>
                                {{-- <input id="profile_text" type="text" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ $user->email }}" required autocomplete="email"> --}}
