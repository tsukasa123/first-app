                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group px-5">
                            <label for="screen_name" class="mb-0">{{ __('Account Name') }}</label>
                        ...
                        <div class="form-group px-5">
                            <label for="name" class="mb-0">{{ __('Name') }}</label>
                        ...
                        <div class="form-group px-5 mb-0">
                            <button type="submit" class="btn btn-primary rounded-pill form-control">
                                {{ __('Register') }}
                            </button>

                            <div class="row justify-content-center">
                                <p class="btn btn-link text-muted pr-1" id="alreadyHaveAnAccount">Already have an account?</p>
                                <a class="btn btn-link pl-0" href="{{ route('login') }}">Log In</a>
                            </div>
                        </div>
