                        ...
                        <div class="card-footer py-1 d-flex justify-content-between bg-white border-top-0">
                            <div class="d-flex">
                                ...
                                <div class="d-flex align-items-center">
                                    @if (!in_array($question->user->id, array_column($question->favorites->toArray(), 'user_id'), TRUE))
                                    ...
                                    @else
                                        <form method="POST" action="{{ url('favorites/' .array_column($question->favorites->toArray(), 'id', 'user_id')[$question->user->id]) }}" class="mb-0">
                                            @csrf
                                            @method('DELETE')
