...
<div class="container">
    <div class="row justify-content-center border rounded bg-white">
        <div class="col-md-8 my-3 d-flex">
            <div class="d-flex">
                <a href="{{ route('questions.index') }}" class="btn btn-primary rounded-pill mb-0 pb-0 mr-2">Recent</a>
                <a class="btn btn-outline-secondary rounded-pill">Trend</a>
            </div>
            <div class="ml-auto">
